...
const prettyFeature = (
  ...
  value
    .replaceAll('numeric__', '')
    .replaceAll('categorical__', '')
    .replaceAll('_', ' ');
...
export default function Insights() {
  ...
  /*
   * The FastAPI backend returns the metrics object
   * directly. No nested response extraction is needed.
   */
  ...
  /*
   * Defensive arrays so the page doesn't crash if
   * a section is missing from metrics.json.
   */
      ...
      <header className="flex flex-col justify-between gap-5 md:flex-row md:items-end">
        ...
        <div className="animate-rise-in">
          ...
          <p className="mt-2 max-w-2xl text-sm leading-6 text-muted-foreground">
            A model is only useful when its performance
            and blind spots are visible. This page keeps
            both in frame.
          </p>
            ...
            <div className="flex flex-col gap-8 lg:flex-row lg:items-end lg:justify-between">
              ...
              <div>
                ...
                <p className="mt-2 max-w-lg text-sm leading-6 text-primary-foreground/65">
                  Held-out evaluation metrics from the
                  trained pipeline. Use recall and
                  precision together when thinking about
                  intervention.
                </p>
          ...
          <section className="grid gap-5 xl:grid-cols-[0.9fr_1.1fr]">
              ...
              confusionMatrix[0]?.length >= 2 ? (
                ...
                <div className="mt-8">
                  ...
                  <p className="mt-6 flex items-start gap-2 text-xs leading-5 text-muted-foreground">
                    ...
                    A false negative can hide an employee
                    who may need support; a false positive
                    can create an unnecessary conversation.
                ...
                <EmptyBlock
                  message="The confusion matrix is empty."
                />
            ...
            <article className="rounded-2xl border border-border bg-card p-6 shadow-sm">
              ...
              {comparison.length ? (
                ...
                <EmptyBlock
                  message="No comparison models returned."
                />
          ...
          <section className="grid gap-5 lg:grid-cols-[1.2fr_0.8fr]">
            ...
            <article className="rounded-2xl border border-border bg-card p-6 shadow-sm">
              ...
              {featureImportance.length ? (
                ...
                <EmptyBlock
                  message="Feature importance is empty."
                />
            ...
            <article className="rounded-2xl border border-border bg-secondary p-6 text-secondary-foreground shadow-sm">
              ...
              <p className="mt-4 text-sm leading-6 text-secondary-foreground/75">
                The strongest features tell you where
                the model finds useful separation in this
                dataset. They do not explain an
                individual’s lived experience or prescribe
                an HR action.
              </p>
              ...
              <div className="mt-7 space-y-3 border-t border-secondary-foreground/15 pt-5 text-sm">
                ...
                <div className="flex gap-3">
                  ...
                  <span>
                    Use conversation before conclusion.
                  </span>
                </div>
